...
impl LsmStorageInner {
    ...
    fn trigger_compaction(&self) -> Result<()> {
        ...
        let sstables = self.compact(&snapshot, &task)?;
        ...
        // insert new SSTs first so apply_compaction_result can sort them
    ...
    fn sst_from_iter(
        ...
        while iter.is_valid() {
            ...
            if compact_to_bottom_level && value.is_empty() {
                // skip deleted entries when compacting to bottom level
            } else {
