...
impl LeveledCompactionController {
    ...
    pub fn generate_compaction_task(
        ...
        // compute target level sizes working backwards from max level
        ...
        // L0 compaction has top priority
        ...
        // pick the level with the highest size/target ratio
    ...
    pub fn apply_compaction_result(
        ...
        // Skip sorting during recovery because SSTs aren't loaded into memory yet
        if !in_recovery {
